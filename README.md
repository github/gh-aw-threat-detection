...
1. Resolves the newest **(pre)release** of both `github/gh-aw` and `github/gh-aw-threat-detection` (each overridable via inputs; falls back to the latest stable release when a repo has no prerelease).
